...
$sql = sprintf("SELECT wines.*,wineries.winery_name,wine_regions.region_name FROM wines,wineries,wine_regions
                    WHERE wines.userid='$uname' and wineries.userid='$uname' and wine_regions.userid='$uname' and wines.winery_id=wineries.winery_id and wines.region_id=wine_regions.region_id");
            ...
            <div class="dash-contents-div">
                <div class="dash-wines-content-container">
                    <div class="dash-wines-add-wine-div">
                        <a href="dash-addWines.php">Add wines</a>
                    </div>

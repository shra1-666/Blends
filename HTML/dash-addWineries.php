        ...
        <div class="dash-content-div">
            ...
            <div class="dash-contents-div">
                <div class="dash-wines-content-container dash-add-wines-container">
                    ...
                    <form class="dash-add-wine-entry-container dash-add-wine-entry-container-add-wineries" action="../PHP/Login/add-wineries.php" method="post">
                        <div class="dash-add-wines-content-div1">
                            <div class="add-wines-sec">
                                <label for="name">Winery name</label>
                                <input name="winery_name" type="text" required>
                            </div>

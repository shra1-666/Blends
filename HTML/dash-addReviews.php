...
$sql = sprintf("SELECT wine_name,wine_id FROM wines
                    WHERE userid='$uname' and wine_id NOT IN (SELECT wine_id FROM reviews)");
        ...
        <div class="dash-content-div">
            ...
            <div class="dash-contents-div">
                <div class="dash-wines-content-container dash-add-wines-container">
                    ...
                    <form class="dash-add-wine-entry-container dash-add-wine-entry-container-add-wineries" action="../PHP/Login/add-review.php" method="post">
                        ...
                        <div class="dash-add-wines-content-div2">
                            ...
                            <div class="add-wines-sec">
                                ...
                                <input name="review_text" type="text" required>
                            </div>
                        </div>
